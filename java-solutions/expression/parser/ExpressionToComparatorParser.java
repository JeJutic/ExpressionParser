...
public class ExpressionToComparatorParser extends BaseParser {
    ...
    public ExpressionToComparatorParser(CharSource source) {
        this(
                source,
                List.of(
                ...
                List.of(
                        new NegatePlugin(), new CountPlugin()
                )
        );
    }

    protected ExpressionToComparatorParser(
            CharSource source,
    ...
    public ExpressionComparator parse() throws ParsingException {
    ...
    private ExpressionComparator subParse() throws ParsingException {
    ...
    private ExpressionComparator parseSequence(EXPRESSION_PRIORITY priority) throws ParsingException {
    ...
    private ExpressionComparator parseElement() throws ParsingException {
        skipWhitespaces();
    ...
    private int parsePositiveInt(boolean neg) throws ParsingException {
        ...
        try {
            ...
            throw error("Unable to parse the integer", e);
        }
    }
}